...
disp(['* Average/minimum acceptance probability for M: ' num2str(round(sum(stats.acchyp)/its/n*100,1)) ' / ' num2str(round(min(stats.acchyp)/its*100,1)) '  r: ' num2str(round(sum(stats.accr)/its/n*100,1)) ' / ' num2str(round(min(stats.accr)/its*100,1))])
disp(['***********************************************************************************'])
disp([' '])
